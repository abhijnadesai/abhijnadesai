  ...
  return (
    <form name="contact v1" method="POST" data-netlify="true">
      ...
      <div className="mb-4">
        ...
        <textarea
          className="w-[45px] w-full rounded-sm bg-slate-900 pl-4"
          name="message"
          id="message"
          cols={30}
          rows={10}
      ...
      <button className="px-6 cursor-pointer py-3 inline-block capitalize font-semibold bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-md">Send Message</button>
    </form>
  );
};
